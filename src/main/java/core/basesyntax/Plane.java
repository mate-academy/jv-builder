...
public class Plane {
    ...
    private Plane(String model, String color, int weight,
    ...
    public static class PlaneBuilder {
        ...
        PlaneBuilder setModel(String model1) {
            this.model1 = model1;
            return this;
        }

        PlaneBuilder setColor(String color1) {
            this.color1 = color1;
            return this;
        }

        PlaneBuilder setWeight(int weight1) {
            this.weight1 = weight1;
            return this;
        }

        PlaneBuilder setQuantitySeats(int quantityOfSeats1) {
            this.quantityOfSeats1 = quantityOfSeats1;
            return this;
        }

        PlaneBuilder setDimension(int dimensions1) {
